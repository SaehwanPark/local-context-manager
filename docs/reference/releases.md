...
```bash
pi install npm:local-context-manager@0.3.2
```
...
| --- | --- | --- |
| **0.3.2** | Nonfatal compaction recovery | Native cut-point preflight, async failure recovery/backoff, lifecycle-safe callbacks, and synchronized documentation. |
